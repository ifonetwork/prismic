			...
			return {
				init: function(selector) {
					...
					var endPageTransition = function() {
						elAnimIn.split(" ").forEach( function(className) {
							pageTransition.classList.remove(className);
						});
						...
						var removePageTransition = function() {
							...
							(elAnimIn + ' animated').split(" ").forEach(function(className) {
								__core.getVars.elWrapper.classList.add(className);
							});
						};
						...
						var displayContent = function() {
							...
							setTimeout(function() {
								(elAnimIn + ' animated').split(" ").forEach( function(className) {
									__core.getVars.elWrapper.classList.remove(className);
								});
							}, 333);

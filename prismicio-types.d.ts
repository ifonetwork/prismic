...
export interface ImageSliceDefaultItem {
  /**
   * repetable for image field in *Image → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: image.items[].repetable_for_image
   * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
   *
   */
  repetable_for_image: prismic.KeyTextField;
}
/**
 ...
 *
 */
interface UserCardSliceDefaultPrimary {
  /**
   * name field in *UserCards → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: user_card.primary.name
   * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
   *
   */
  name: prismic.KeyTextField;
  /**
   * embadedfield field in *UserCards → Primary*
   *
   * - **Field Type**: Embed
   * - **Placeholder**: *None*
   * - **API ID Path**: user_card.primary.embadedfield
   * - **Documentation**: https://prismic.io/docs/core-concepts/embed
   *
   */
  embadedfield: prismic.EmbedField;
  /**
   * avatar field in *UserCards → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: user_card.primary.avatar
   * - **Documentation**: https://prismic.io/docs/core-concepts/image
   *
   */
...
/**
 * Default variation for UserCards Slice
 *
 * - **API ID**: `default`
 * - **Description**: `Default`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
export type UserCardSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<UserCardSliceDefaultPrimary>,
  never
>;
/**
 * Slice variation for *UserCards*
 *
 */
type UserCardSliceVariation = UserCardSliceDefault;
/**
 * UserCards Shared Slice
 *
 * - **API ID**: `user_card`
 ...
 *
 */
export type UserCardSlice = prismic.SharedSlice<
  "user_card",
